...
exports.getLineStatus = function(req,res) {
    ...
    console.log(`[getAllStatus][${req.params.linha}] Já que você pediu, o Math.Random() é ${store.get('statusLinhas')}`);
    res.end(`[getAllStatus][${req.params.linha}] Já que você pediu, o Math.Random() é ${store.get('statusLinhas')}`);
